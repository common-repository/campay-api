...
Order will timeout after 2 minutes',
 ...
 ?>
                 <div class="row css_accordion">
                    ...
                    echo '<div class="form-row form-row-wide"><label>Enter a valid MTN or ORANGE Money number <span class="required">*</span></label>
		...
		public function validate_fields() {
			...
			if( empty( $_POST[ 'campay_transaction_number' ]) &&  $payment_option != "card") {
				wc_add_notice(  'Please enter a number to proceed the transaction', 'error' );
				return false;
			}
